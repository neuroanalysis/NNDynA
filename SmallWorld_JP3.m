...
function Experiment = SmallWorld_JP3(Experiment)
    ...
    Experiment.SmallWorld.IsUltra=IsUltra;
    Experiment.SmallWorld.IsSmall=IsSmallWorld;
    Experiment.SmallWorld.Properties=Properties;
